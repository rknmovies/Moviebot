...
API_ID = int(environ.get('API_ID', '23958734'))
API_HASH = environ.get('API_HASH', '8e9d5e4fb2dfa19a3b536ffe870fe37a')
BOT_TOKEN = environ.get('BOT_TOKEN', "7581357090:AAE1jsXMMC24bIqrdIJbGKg4pA__hiZhP3c")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/gpR.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7342623120').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1511468725').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002402253939'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002385281503').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002434101070') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request File With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002402253939')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None

# This Is Your Bot Support Group Id , Here Bot Will Not Give File Because This Is Support Group.
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002319268477')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002396132554')).split()]  # For Multiple Id Use One Space Between Each.
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Kicchacollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/newgruoppy')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/newmivie09')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'moviegruo') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/CallmeNayak')
